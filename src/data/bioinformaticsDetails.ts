...
/* eslint-disable no-template-curly-in-string -- these strings render literal Nextflow/shell code samples containing intentional ${...} syntax, not accidental template literals */
